    ...
    <div class="row">
      ...
      <div class="col-6 col-md-3 mb-4">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary"><span class="glyphicon glyphicon-home"></span>&nbsp;Chh. Sambhajinagar, India</a></li>
          <li class="nav-item mb-2"><a href="mailto:inkwell@gmail.com"" class="nav-link p-0 text-body-secondary"><span class="glyphicon glyphicon-envelope"></span>&nbsp;inkwell@gmail.com</a></li>
        </ul>
      </div>
    </div>
    </footer>
