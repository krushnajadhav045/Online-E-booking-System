...
<style>
    ...
    <!-- Now for the payment form -->
        <div class="col-md-5">
            ...
            <br>
            <form class="border-class" id="infoForm" method="POST" action="payscript.php">
              <div class="form-row">
              ...
              <div class="form-row">
                  <div class="form-group col-md-5 card-details">
                    ...
                    <input type="text" class="form-control" name="cardNumber" maxlength="16" value="<?php echo $customer['cardnumber']?>">
                  </div>
                  <div class="form-group col-md-5 card-details">
